...
<template>
    ...
    >
        ...
        <div
            class="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 pt-4"
        >
            <div class="flex flex-shrink-0 items-center px-4">
                <Link :href="route('home')" class="myPrimaryLink">
                    <svg
    ...
    <div class="flex flex-1 flex-col md:pl-64">
        <div
            class="h-16 sticky top-0 z-10 flex flex-shrink-0 justify-end items-center bg-white border-b-2 border-myPrimaryBrandColor"
        >
            <button
                type="button"

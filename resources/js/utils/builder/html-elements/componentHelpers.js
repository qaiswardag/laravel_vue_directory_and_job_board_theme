...
const componentHelpers = [
    {
        html_code: `<section><div class="relative py-4"><div class="mx-auto max-w-7xl"><h2>Bonjour Comment Ça Va</h2></div></div></section>`,
        id: null,
        title: "Header H2",
    },
    {
        html_code: `<section><div class="relative py-4"><div class="mx-auto max-w-7xl"><h3>Bonjour Comment Ça Va</h3></div></div></section>`,
        id: null,
        title: "Header H3",
    },
    {
        html_code: `<section><div class="relative py-4"><div class="mx-auto max-w-7xl"><p>
        ...
        Placerat in egestas erat imperdiet. Ultrices gravida dictum fusce ut placerat. 
        ...
        Egestas purus viverra accumsan in nisl nisi. Pretium nibh ipsum consequat nisl vel pretium.
        </p></div></div></section>`,
        id: null,

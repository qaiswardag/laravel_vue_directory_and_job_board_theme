...
const componentHelpers = [
    {
        ...
        <div>
        <p>Text</p><p>Tempus imperdiet nulla malesuada pellentesque elit eget gravida cum sociis. Erat nam at lectus urna duis convallis convallis. Congue mauris rhoncus aenean vel elit scelerisque. 
        ...
        Consequat mauris nunc congue nisi vitae suscipit tellus mauris. <br><br></p><p>List</p><ul><li><p>Integer enim neque volutpat ac tincidunt vitae semper quis. Sit amet consectetur adipiscing elit pellentesque.</p></li><li><p>Urna cursus eget nunc scelerisque viverra. 
    ...
    },
    {
        ...
        <div class="py-4">
        <div class="mx-auto max-w-7xl lg:px-4 px-2">
        <div class="video-container w-full aspect-video bg-slate-100 border border-slate-200 rounded-xl lg:p-8 md:p-6 p-4">

...
<template>
  <FullWidthElement :descriptionArea="true" class="bg-gray-100">
    ...
    <template #description>
      You are currently viewing the latest resources uploaded by your team.
      These resources are sorted by date, with the most recent ones displayed
      first.
    </template>
    <template #content>
      <!-- Error - start -->
      ...
      >
        <!-- column start -->
        <div class="lg:col-span-6 w-full rounded py-10 px-4 bg-white h-full">
          <h2 class="my-2 mb-4 myFourthHeader">Latest Team Members</h2>
            ...
            <ul role="list" class="grid grid-cols-1 myPrimaryGap">
              ...
              >
                ...
                <div class="flex items-center gap-2 my-2">
                  <div
                    v-if="member && member.profile_photo_path !== null"
                    class="flex-shrink-0"
                  >
                    <img
                  ...
                  <div
                    v-if="
                      $page.props.user && member.profile_photo_path === null
                    "
        ...
        <div class="lg:col-span-6 w-full rounded py-10 px-4 bg-white h-full">
          ...
          <div class="min-h-[36rem] max-h-[36rem] overflow-y-scroll">
            ...
            >
              <li
                v-for="file in getDashboardStats.fetchedData.latestMedia"
                :key="file.id"
                class="rounded"
              >
                <div
        ...
        <div class="lg:col-span-6 w-full rounded py-10 px-4 bg-white h-full">
          ...
          <div class="min-h-[36rem] max-h-[36rem] overflow-y-scroll">
            <ul role="list" class="grid grid-cols-1 myPrimaryGap">
              <li
                v-for="post in getDashboardStats.fetchedData.latestPosts"
                :key="post.id"
              ...
              >
                ...
                <div class="flex items-center gap-2 my-2">
                  <div
                    v-if="post && post.cover_image_medium !== null"
                    class="flex-shrink-0"
                  >
                    <img
                      class="object-cover w-10 h-10 rounded-full"
                  ...
                  <div v-if="post && post.cover_image_medium === null"></div>
                ...
                <p class="text-xs">
                  <span
                    ...
                    >{{ post.published ? 'Published' : 'Privat' }}</span
                  >
                </p>
              </li>
            </ul>
  ...
  <FullWidthElement :descriptionArea="true" class="bg-red-100">
    ...
    >
    <template #description>
      Retrieve details about the logged-in user and team insights for current
      user. Discover insights about the logged-in user and the team.
    </template>
    <template #content>
          ...
          <dl class="divide-y divide-myPrimaryMediumGrayColor">
            ...
            >
              ...
              <DisclosurePanel as="dd" class="mt-2 pr-12 pb-16">
                <p class="myPrimaryParagraph whitespace-pre-line">
                  {{ faq.answer }}
                </p>
              </DisclosurePanel>
            </Disclosure>

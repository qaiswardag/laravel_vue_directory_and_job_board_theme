    ...
    <div class="flex items-center justify-center gap-2">
        <div class="flex gap-2 items-center justify-center">
            <div
                ...
                class="h-10 w-10 cursor-pointer rounded-full flex items-center justify-center bg-gray-50 aspect-square hover:bg-myPrimaryErrorColor hover:text-white text-myPrimaryErrorColor"
            >

    ...
    <div class="mx-auto max-w-7xl">
      <div class="myPrimaryGap grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
        <div class="flex-1 py-2">
          <img class="object-cover w-full object-top aspect-[9/16] smooth-transition" src="https://www.admin.myself.ae/storage/uploads/2/2024/05/00058_chanel_resort_2025_credit_gorunway_f1htzhg9lfzjp1715525583_large.webp" alt="provider">
        </div>
        <div class="flex-1 py-2">
          <img class="object-cover w-full object-top aspect-[9/16] smooth-transition" src="https://www.admin.myself.ae/storage/uploads/2/2024/05/00011_chanel_resort_2025_credit_gorunway_ib8radavtvaqsx1715525588_large.webp" alt="provider">
        </div>
      </div>
    </div>
  </div>
...
<section data-componentid="a161f639-5f37-43fa-9080-839791542280">
  <div class="w-full md:pt-12 md:pb-12 pt-4 pb-4 lg:px-4 px-2">
    <div class="mx-auto max-w-7xl">
      <div class="myPrimaryGap grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2">
        <div class="flex-1 py-2">
          <img class="object-cover w-full object-top aspect-[9/16] smooth-transition" src="https://www.admin.myself.ae/storage/uploads/2/2024/05/00022_chanel_resort_2025_credit_gorunway_ji3ilzjqxf61715525586_large.webp" alt="provider">
        </div>
        <div class="flex-1 py-2">
          <img class="object-cover w-full object-top aspect-[9/16] smooth-transition" src="https://www.admin.myself.ae/storage/uploads/2/2024/05/00024_chanel_resort_2025_credit_gorunway_skpregry1715525580_large.webp" alt="provider">
        </div>
      </div>
    </div>
  </div>

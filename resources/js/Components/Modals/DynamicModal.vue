        ...
        <div class="flex flex-col px-6 py-4 bg-gray-100 text-right">
            ...
            >
                ...
                <div v-if="secondButtonText">
                    <div
                        v-if="
                            disabled && disabledWhichButton === 'secondButton'
                        "
                    >
                        <button
                ...
                <div v-if="thirdButtonText">
                    <div v-if="type === 'default'">
                        ...
                        >
                            <button
                                class="flex items-center gap-2 myPrimaryButton bg-emerald-500 focus-visible:ring-emerald-500 focus:ring-emerald-500 hover:bg-emerald-600 text-sm w-full"
                                :class="{
                                    'opacity-25 cursor-default': disabled,
                                }"
                                :disabled="disabled"

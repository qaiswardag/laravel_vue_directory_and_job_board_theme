                  ...
                  <table class="myPrimaryTable" aria-describedby="index">
                    <thead class="myPrimaryTableTHead">
                      <tr class="myPrimaryTableTr">
                        <th scope="col" class="myPrimaryTableTh">Logo</th>
                        <th scope="col" class="myPrimaryTableTh">
                          Cover image
                        </th>
                        <th scope="col" class="myPrimaryTableTh">Team Name</th>

                        <th scope="col" class="myPrimaryTableTh">Status</th>
                        <th scope="col" class="myPrimaryTableTh">Your Role</th>
                        <th scope="col" class="myPrimaryTableTh">
                          Switch Team
                        </th>
                      ...
                      >
                        ...
                        <td class="myPrimaryTableTBodyTd">
                          <span
                            ...
                            "
                            >{{ team.public ? 'Public' : 'Private' }}</span
                          >
                        </td>
                        ...
                        <td class="myPrimaryTableTBodyTd">
                          {{
                            team.membership
                              ? team.membership.role.charAt(0).toUpperCase() +
                                team.membership.role.slice(1)
                              : 'Owner'
                          }}
                        </td>
                        <td class="myPrimaryTableTBodyTd">
                          ...
                          >
                            ...
                            >
                              ...
                              type="button
                                class="myPrimaryButtonNoBackground text-myPrimaryDarkGrayColor flex items-center gap-2"
                              >
                                <div>Switch to Team for Edit</div>
                              </button>
                            </div>
                          </form>
                          <Link
                            v-if="
                              ...
                              team.id === $page.props.user.current_team_id
                            "
                            :href="route('team.update.information', team.id)"

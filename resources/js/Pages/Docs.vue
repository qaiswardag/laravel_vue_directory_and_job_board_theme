    ...
    <LoggedInLayout title="Docs">
        ...
        <div class="myPrimarySection">
            ...
            <div class="mb-8 p-4 border-2 border-emerald-500 rounded-xl">
                ...
                <p class="myPrimaryParagraph my-2">
                    In fact, you might even notice this at Laracasts if you're
                    watching a video and then you click away, the video will
                    keep playing in the bottom-right corner. I do that through
                    persistent layouts.
                </p>
                <p class="myPrimaryParagraph my-2">
                    Luckily, it's really easy to implement. The solution is to
                    effectively reverse it. So rather than the layout being a
                    child of the users page, I instead want the users page to be
            ...
            <div class="mb-8 p-4 border-2 border-emerald-500 rounded-xl">
                ...
                <p class="myPrimaryParagraph my-2">
                    ...
                    access to all users data like Stripe token. Only return data
                    which is relevant. Use service providers.
                </p>

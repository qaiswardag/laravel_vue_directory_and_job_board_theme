...
class StoreDestroyPaymentMethod extends FormRequest
{
    /**
        ...
        $validator->after(function ($validator) use (
            ...
            if ($paymentMethodId === $defaultPaymentMethodId) {
                $validator
                    ...
                    ->add(
                        "payment_method_id",
                        "Unable to delete the default payment method. Please change your default payment method and then proceed with deleting this method."
                    );
            }
        });
